        ...
        <>
            <section className="bg-gray-50 dark:bg-gray-900 flex items-center justify-center h-screen">
                <div className='w-full p-6 bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-10 '>
                    {showEmailForm && (
                        <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" id='email-form' onSubmit={handleSubmitEmailForm}>
                            <div>
                                <label htmlFor="email" className="block mb-5 text-sm font-semibold text-gray-900 dark:text-white font-sans md:text-xl  "> Enter your email</label>
                                <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required />
                            </div>
                            <div>
                                <button type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-blue-500">Submit</button>
                            </div>
                        </form>
                    )}
                    {showOTPForm && (
                        <form className="max-w-sm mx-auto" id='otp-form' onSubmit={handleSubmitOTPForm}>
                            ...
                            <button type="submit" className="ml-32 mt-5 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 hover:bg-blue-800 bg-blue-500">Submit</button>
                        </form>
                    )}
                    {showCNFForm && (
                        <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" id='cnf-pass' action="#">
                            ...
                            <button type="submit" className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-blue-500">Reset password</button>
                        </form>
                    )}
                </div>
            </section>
