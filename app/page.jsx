...
export default function Home() {
  ...
  tabIndex="-1"
  aria-hidden="true"
  className="hidden overflow-y-auto overflow-x-hidden fixed z-20 bg-transparent justify-end items-start w-full md:inset-0 h-[calc(100%-1rem)] max-h-full top-4 right-4"
